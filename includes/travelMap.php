    ...
    <script type="text/javascript">
        function initialize() {
            var trips = [
                ...
                [40.851775, 14.268124, 'Naples, Italy'],
                [40.746157, 14.498934, 'Pompeii, Italy'],
                [41.902783, 12.496366, 'Rome, Italy'],
                [52.370216, 4.895168, 'Amsterdam, The Netherlands'],
                [50.850340, 4.351710, 'Brussels, Belgium'],
                [48.135125, 11.581981, 'Munich, Germany'],
                [47.376887, 8.541694, 'Zurich, Switzerland'],
                [47.559599, 7.588576, 'Basel, Switzerland'],
                [46.686348, 7.863205, 'Interlaken, Switzerland'],
                [46.607358, 7.964836, 'Lauderbrunnen, Valley, Switzerland'],
                [46.624164, 8.041396, 'Grindlewald, Switzerland'],
                [41.385064, 2.173403, 'Barcelona, Spain'],
                [41.593118, 1.838062, 'Monserrat, Spain'],
                [38.722252, -9.139337, 'Lisbon, Portugal'],
                [38.802869, -9.381659, 'Sintra, Portugal'],
                [43.284771, -2.171397, 'Zarautz, Spain'],
                [43.263013, -2.934985, 'Bilbao, Spain'],
                [42.812526, -1.645775, 'Pamplona, Spain'],
                [41.648823, -0.889085, 'Zaragoza, Spain'],
                //S. America
                ...
                [32.776664, -96.796988, 'Dallas, TX, USA'],
                [35.221997, -101.831297, 'Amarillo, TX, USA'],
                [35.085334, -106.605553, 'Albuquerque, NM, USA'],
                [35.024187, -110.697357, 'Winslow, AZ, USA' ],
                [36.054445, -112.140111, 'Grand Canyon, USA'],
                [34.052234, -118.243685, 'Los Angeles, CA, USA'],
                [34.197505, -119.177052, 'Oxnard, CA, USA'],
                [37.774929, -122.419416, 'San Francisco, CA, USA'],
                [41.422650, -122.386127, 'Weed, CA, USA'],
                [44.052069, -123.086754, 'Eugene, OR, USA'],
                [45.523062, -122.676482, 'Portland, OR, USA'],
                //Africa
